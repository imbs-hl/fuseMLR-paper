...
#' Function to fit and predict target variable using weighted mean (WM).
#'
...
#'
create_pred_fuseMLR_wm <- function(data_name_list,
                                   output_dir,
                                   suffix,
                                   rep,
                                   seed_values,
...
create_pred_fuseMLR_wm(data_name_list = data_name_list,
