...
results_dir <- file.path(simulation_dir, "data_results")
functions_dir <- file.path(simulation_dir, "functions")
script_dir <- file.path(simulation_dir, "scripts")
img_dir <- file.path(simulation_dir, "img")
...
source(file.path(functions_dir, "create_f1_score.R"))
